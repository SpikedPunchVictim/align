...
project's promotion-on-evidence doctrine. The probe (`docs/adr/proposals/security-manifest-gate/manifest-security-probe/MANIFEST_PROBE_REPORT.md`, 2026-07-12) measured
...
`docs/adr/proposals/security-manifest-gate/manifest-security-probe/MANIFEST_PROBE_REPORT.md` (2026-07-12) — full measured results across align/kluster/n8n for all seven
