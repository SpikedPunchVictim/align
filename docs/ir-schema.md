...
user-approved, on evidence from `docs/adr/proposals/security-manifest-gate/manifest-security-probe/MANIFEST_PROBE_REPORT.md`'s manifest-security probe — see
...
**Promoted 2026-07-12** (user-approved, ADR 013) on evidence from `docs/adr/proposals/security-manifest-gate/manifest-security-probe/MANIFEST_PROBE_REPORT.md`
...
exposure sibling (`docs/adr/proposals/security-manifest-gate/manifest-security-probe/MANIFEST_PROBE_REPORT.md` Rule 2 — install-dependent, held back pending the
