...
/** Re-exported so every existing importer of `align-dir.js` keeps working unchanged: `.align/`'s
 * location and the version artifact moved to `align-version-file.ts` (LEDGER D031) without moving
 * their public import path. */
export { ALIGN_DIR, alignDirPath, ensureAlignDir, readVersionFile, recordBaselineReconciled };
