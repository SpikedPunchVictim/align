 ...
 * pattern docs/adr/proposals/security-manifest-gate/manifest-security-probe/MANIFEST_PROBE_REPORT.md Rule 1 verified 3/3 real, 0 false positives against n8n. */
